...
\\\\
Variant constructors are monomorphic, that is, for any constructor $nonconst$, there exist types $\tau_{1}...\tau_{n}$ such that for any application of constructor $nonconst$ to arguments $v_{1}...v_{n}$, $v_{i}$ must have type $\tau_{i}$ for all $i\in1...n$.
