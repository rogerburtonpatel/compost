...
; %bb.0:                                ; %entry
	...
	.cfi_offset w29, -16
Lloh8:
	adrp	x0, _sym_lit.1@PAGE
Lloh9:
	add	x0, x0, _sym_lit.1@PAGEOFF
	bl	_printf
	bl	__f
	and	w0, w0, #0x1
	ldp	x29, x30, [sp], #16             ; 16-byte Folded Reload
...
; %bb.0:                                ; %entry
	...
	.cfi_offset w29, -16
Lloh10:
	adrp	x0, _sym_lit@PAGE
Lloh11:
	add	x0, x0, _sym_lit@PAGEOFF
	bl	_printf
	bl	__g
	and	w0, w0, #0x1
	ldp	x29, x30, [sp], #16             ; 16-byte Folded Reload
	...
	.globl	_sym_lit                        ; @sym_lit
_sym_lit:
	.ascii	"f called"

	.globl	_sym_lit.1                      ; @sym_lit.1
_sym_lit.1:
	.ascii	"g called"
