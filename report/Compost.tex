...
\subsection{Roger Burtonpatel} {
  ...
  I prefer the syntax Standard ML, and wish I could have used ML with the 
...
\subsection{Randy Dang} {
    ...
    Object-Oriented manner, which was less clean approach). Using existing parsing tools (such as Menhir)
...
\subsection{Jackson Warhover} {
    ...
    We had a good plan from the start for exacrly how to implement IRs, which made creating them very simple. 
    ...
    I also learned that communication of invariants is important. For invariants that are not inheritly
    ...
    In terms of testing, I learned just how critical the initial work on testing infastructure can be. For us,
    a lot of this work was correctly put in early on, and refactors were made as necessary, which might have
    bren time consuming in the moment, but equated to a significant reduction in workload for tests going
    forward.

    I also agree with Randy about how functional programing is perfect for writing a compiler. This might judt
    be because I'm used to it at this point, but I really cant imagine implementing something nearly as clean
