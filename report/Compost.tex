...
\subsection{Project Timeline} {
    ...
    \begin{tabular}{|c|c|}
        ...
        \hline 
        Oct 30 - Nov 8 & Implement Bare Minimum Functionality in Each \\ 
        & Pass for ``Hello World'' and Basic Arithmetic \\ 
        \hline 
        ...
        & \& Experiment with Crazy Programs (e.g. Brainf**k) \\ 
        \hline 
    \end{tabular}
}
...
\subsection{Roles and Responsibilities} {
    ...
    meetings and ensuring that we were making steady progress according to the course 
    deliverable deadlines. He usually coordinated the submission process for such deliverables, 
    writing necessary documentation and checking that our submissions met the criteria.
    \\\\
    Jasper Geer was assigned the role of \textit{language guru}, who was responsible for making 
    semantic decisions surrounding the Compost language. (WORK IN PROGRESS)
}
