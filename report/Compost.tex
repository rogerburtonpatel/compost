...
\textbf{ALERT: Hi, Randy Dang here. Reading through a copy-pasted form of the LRM is still a work-in-progress, and some of the section headers are LRM-specific 
rather than general sections that should be included in the report. Go to "Project Plan" for the next report-specific section after the LRM.}
