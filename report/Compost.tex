...
\subsection{Roles and Responsibilities} {
    ...
    meetings, coordinating logistics such as setting up GitHub, and coordinating plans to 
    ensure that we were making steady progress on our compiler according to the course 
...
\subsection{Version Control Commits} {
    Below are two visualizations containing commit information generated by GitHub.
    \\\\
    The first is a visualization of the frequency of commits over time:
    \\\\
    \includegraphics[scale=0.75]{images/commitvis.PNG}
    \\\\
    The second is a visualization of the amount of additions and deletions to files over time:
    \\\\
    \includegraphics[scale=0.5]{images/codefreqvis.PNG}
}
...
\label{sec:architecture} {
    The overall architecture of our compiler can be described by a ``pipe'' that begins with the Compost 
    ...
    \hline 
    Type Checking & Roger Burtonpatel \\ 
    \hline 
    Consumption Checking \& K Normalization & Jasper Geer \\ 
    \hline 
    Insertion of Frees & Jasper Geer \\ 
    \hline 
    Generation of Explicit Memory Management Functionality & Randy Dang \\ 
    \hline 
    Codegen & Jasper Geer \\ 
    \hline 
    \end{tabular}
