...
\begin{lstlisting}
(define-datatype ilist  ;; example datatype definition of a list of ints
...
(: concat (-> (ilist ilist) ilist)) ;; a top-level type annotation
...
(: filterge (-> (int ilist) ilist)  ;; a top-level type annotation giving
                                    ;; a type for `filterge'
...
(: filterlt (-> (int ilist) ilist)  ;; a top-level type annotation giving
                                    ;; a type for `filterlt'
